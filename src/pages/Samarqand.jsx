...
// Samarqand qurilmalari ma'lumotlari - DEFAULT YO'Q
const samarqandDevices = [];  // Bo'sh array
...
export default function SamarqandContact() {
  ...
  const playRingtoneSound = useCallback(() => {
    ...
    console.log("📱 Rington: YANGI QURILMA SO'ROVI KELDI - SAMARQAND");
  }, [createRingtoneSound]);
  ...
  useEffect(() => {
    try {
      ...
      socketRef.current.onopen = () => {
        console.log("✅ WebSocket ulandi - SAMARQAND (Railway)");

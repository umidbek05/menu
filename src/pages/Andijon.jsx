...
// Andijon sektorlari ma'lumotlari - DEFAULT YO'Q
const andijanSectors = [];  // Bo'sh array
...
export default function AndijonContact() {
  ...
  const [savedLocations, setSavedLocations] = useState(() => {
    ...
    return andijanSectors.map(device => ({
      id: `LOC-${device.id}`,
      name: device.name,
      lat: device.lat,
      lng: device.lng,
  ...
  const playRingtoneSound = useCallback(() => {
    ...
    console.log("📱 Rington: YANGI QURILMA SO'ROVI KELDI - ANDIJON");
  }, [createRingtoneSound]);
  ...
  useEffect(() => {
    try {
      ...
      socketRef.current.onopen = () => {
        console.log("✅ WebSocket ulandi - ANDIJON (Railway)");
        ...
        <div className="p-4 bg-gray-900/90 backdrop-blur-md border-b border-emerald-500/20 z-[1000]">
          <div className="flex items-center justify-between gap-4">
            <h1 className="text-xl font-black text-emerald-400 uppercase italic tracking-tighter flex items-center gap-2 whitespace-nowrap">
              <Map className="w-5 h-5" /> Andijon Signal Mapper
            </h1>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="Masalan: Andijon-001"
                />
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="Masalan: ESP32-001 yoki AND-01"
                />
                {deviceIdError ? (

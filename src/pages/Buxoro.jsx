...
// Buxoro qurilmalari ma'lumotlari - DEFAULT YO'Q
const bukharaNodes = [];  // Bo'sh array
...
export default function BukharaContact() {
  ...
  const playRingtoneSound = useCallback(() => {
    ...
    console.log("📱 Rington: YANGI QURILMA SO'ROVI KELDI - BUXORO");
  }, [createRingtoneSound]);
  ...
  // WebSocket ulanish - Railway URL bilan (XORAZM BILAN BIR XIL)
  useEffect(() => {
    try {
      ...
      socketRef.current.onopen = () => {
        console.log("✅ WebSocket ulandi - BUXORO (Railway)");
        ...
        <div className="p-4 bg-gray-900/90 backdrop-blur-md border-b border-emerald-500/20 z-[1000]">
          <div className="flex items-center justify-between gap-4">
            <h1 className="text-xl font-black text-emerald-400 uppercase italic tracking-tighter flex items-center gap-2 whitespace-nowrap">
              <Map className="w-5 h-5" /> Buxoro Signal Mapper
            </h1>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="Masalan: ESP32-001 yoki BUX-01"
                />
                {deviceIdError ? (
